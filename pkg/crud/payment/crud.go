...
func CreateSet(c *ent.PaymentCreate, in *npool.AccountReq) *ent.PaymentCreate {
	if in.ID != nil {
	...
	if in.AvailableAt != nil {
		c.SetAvailableAt(in.GetAvailableAt())
	}
	return c
}

func Create(ctx context.Context, in *npool.AccountReq) (*ent.Payment, error) {
...
func CreateBulk(ctx context.Context, in []*npool.AccountReq) ([]*ent.Payment, error) {
	var err error
	...
	err = db.WithTx(ctx, func(_ctx context.Context, tx *ent.Tx) error {
		...
		for i, info := range in {
			bulk[i] = CreateSet(tx.Payment.Create(), info)
		}
...
func UpdateSet(info *ent.Payment, in *npool.AccountReq) *ent.PaymentUpdateOne {
	...
	if in.AvailableAt != nil {
		u.SetAvailableAt(in.GetAvailableAt())
	}

	return u
}

func Update(ctx context.Context, in *npool.AccountReq) (*ent.Payment, error) {
	var info *ent.Payment
	var err error
...
func Delete(ctx context.Context, id uuid.UUID) (*ent.Payment, error) {
	var info *ent.Payment
	var err error
	...
	err = db.WithClient(ctx, func(_ctx context.Context, cli *ent.Client) error {
		info, err = cli.Payment.UpdateOneID(id).
