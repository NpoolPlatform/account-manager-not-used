...
var (
	...
	targetUserID = entity.TargetUserID.String()
	req          = npool.TransferReq{
		ID:           &id,
		AppID:        &appID,
		UserID:       &userID,
