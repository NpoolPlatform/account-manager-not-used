...
var schemaGraph = func() *sqlgraph.Schema {
	...
	graph.Nodes[2] = &sqlgraph.Node{
		...
		Fields: map[string]*sqlgraph.FieldSpec{
			...
			goodbenefit.FieldIntervalHours: {Type: field.TypeUint, Column: goodbenefit.FieldIntervalHours},
		},
	}
...
// WhereIntervalHours applies the entql uint predicate on the interval_hours field.
func (f *GoodBenefitFilter) WhereIntervalHours(p entql.UintP) {
