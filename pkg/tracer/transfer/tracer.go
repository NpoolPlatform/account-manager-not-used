...
func trace(span trace1.Span, in *npool.TransferReq, index int) trace1.Span {
	span.SetAttributes(
		attribute.String(fmt.Sprintf("ID.%v", index), in.GetID()),
		attribute.String(fmt.Sprintf("AppID.%v", index), in.GetAppID()),
		attribute.String(fmt.Sprintf("UserID.%v", index), in.GetUserID()),
		attribute.String(fmt.Sprintf("TargetUserID.%v", index), in.GetTargetUserID()),
	)
	return span
}

func Trace(span trace1.Span, in *npool.TransferReq) trace1.Span {
...
func TraceMany(span trace1.Span, infos []*npool.TransferReq) trace1.Span {
