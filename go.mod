module github.com/NpoolPlatform/account-manager
...
require (
	...
	github.com/NpoolPlatform/appuser-manager v0.0.0-20220831081940-976d0153f455
	...
	github.com/NpoolPlatform/message v0.0.0-20220901064733-2806ef0c056c
